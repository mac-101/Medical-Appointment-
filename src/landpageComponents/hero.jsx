        ...
        <header className="relative h-screen min-h-175 w-full text-white">
            ...
            <nav className="relative z-10 flex items-center justify-between px-10 py-6 max-w-7xl mx-auto">
                ...
                <div className="hidden md:flex gap-8 text-sm font-medium">
                    <a href="/" className='hover:scale-115 hover:text-blue-600'>Home</a>
                    <a className='hover:scale-115 hover:text-blue-600' href="/">Find a provider</a>
                    <a className='hover:scale-115 hover:text-blue-600' href="/">Find care</a>
                    <a className='hover:scale-115 hover:text-blue-600' href="/">Location</a>
                </div>
                <a href="/login" >
